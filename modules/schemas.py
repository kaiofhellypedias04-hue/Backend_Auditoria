...
class NotaReportRow(BaseModel):
    ...
    simples_xml: Optional[str] = None
    simples_nacional: Optional[str] = None
    consulta_simples_api: Optional[str] = None
    status_simples_nacional: Optional[str] = None
    divergencia_simples_nacional: Optional[bool] = None
    campos_ausentes_xml: Optional[str] = None
    possui_campos_ausentes_xml: Optional[bool] = None
    alertas_fiscais: Optional[str] = None
    possui_alertas_fiscais: Optional[bool] = None
